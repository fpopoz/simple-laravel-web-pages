...
<div class="container-fluid">
  ...
  <section class="content">
     ...
     @endif
  	...
  	<form method="post" action="{{url('updateCategory')}}/{{$maindata->caid}}" >

  		{{ csrf_field() }}
  		<input type="hidden" name="tbl" value="{{encrypt('categories')}}">
      <input type="hidden" name="caid" value="{{$maindata->caid}}">
...
<div class="form-group">
     	<label>Title</label>
     	<p><input type="text" name="title" value="{{$maindata->title}}" class="form-contol"></p>
     </div>
