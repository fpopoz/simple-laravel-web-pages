      ...
      <div class="hero_section" >
        <div class="row">
          ...
          <div class="col-lg-7 col-sm-5">
			<img src="{{url('public/frontend/contentas')}}/{{$about->image}}" class="zoomIn wow animated" alt="" />
		  </div>
        </div>
      </div>
    </div>
...
<footer class="footer_wrapper" id="contact">
  ...
  <div class="container">
    <div class="footer_bottom"><span>Copyright © {{ date('Y')}}, developed by <a href="http://www.popozgraphics.com">Popozgraphics.com</a>. </span> </div>
  </div>
</footer>
